...
//        addIceServers(iceServers);
    ...
    public static List<PeerConnection.IceServer> defaultIceServers(){
        ...
        //iceServers.add(new PeerConnection.IceServer("stun:turn.skipodevelop.com:5349", "teledom", "teledom"));
        //iceServers.add(new PeerConnection.IceServer("turn:turn.skipodevelop.com:3478", "teledom", "teledom"));
