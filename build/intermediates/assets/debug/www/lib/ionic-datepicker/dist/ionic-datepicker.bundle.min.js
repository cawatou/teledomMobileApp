...
function(e) {
    ...
    this.configDatePicker = function(n) {
        ...
        function r(e) {
            u.mainObj = angular.copy(e), u.selctedDateEpoch = i(u.mainObj.inputDate).getTime(), u.mainObj.weeksList && 7 === u.mainObj.weeksList.length ? u.weeksList = u.mainObj.weeksList : u.weeksList = ["S", "M", "T", "W", "T", "F", "S"], u.mainObj.mondayFirst && u.weeksList.push(u.mainObj.weeksList.shift()), u.disableWeekdays = u.mainObj.disableWeekdays, d(u.mainObj.inputDate), c(u.mainObj)
        }
        ...
        return u.today = i(new Date).getTime(), u.disabledDates = [], u.data = {}, u.prevMonth = function() {
            ...
            u.modal.remove()
				}), u.$on("modal.hidden", function() {
					u.$emit('datepicker', 'closeIonicDatePickerModal')
    ...
    this.monthsList = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.getYearsList = function(e, n) {
        var t = [],
            a = 1900,
            o = 2100;
